	...
	<div class="layui-layout layui-layout-admin">
		<div class="layui-header">
			...
			<ul class="layui-nav layui-layout-left">
				<li class="layui-nav-item"><a href="userList.html"
					target="main">用户管理</a></li>
				<li class="layui-nav-item"><a href="product.html" target="main">供应商管理</a></li>
				<li class="layui-nav-item"><a href="bill.jsp?userId=${user.id }" target="main">订单管理</a></li>
			...
			<div class="layui-side-scroll">
				...
				<ul class="layui-nav layui-nav-tree" lay-filter="test">
					<li class="layui-nav-item layui-nav-itemed"><a class=""
						href="userList.html" target="main">用户管理</a></li>
					<li class="layui-nav-item"><a href="product.html"
						target="main">供应商管理</a></li>
					<li class="layui-nav-item"><a href="bill.jsp?userId=${user.id }" target="main">订单管理</a>
					</li>
